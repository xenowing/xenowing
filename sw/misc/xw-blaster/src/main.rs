        ...
        match device.read_byte()? {
            ...
            0x02 => {
                    ...
                    for block_x in 0..16 / 2 {
                        for y in 0..2 {
                            for x in 0..2 {
                                ...
                                write_word(addr, argb, &mut *device)?;
                            }
                        }
                    }
                }*/
                ...
                for i in 0..1/*5*/ {
                    ...
                    let mut assemble_triangle = |mut verts: [Vertex; 3]| -> Result<(), Error> {
                        let viewport_x = 0;
                        let viewport_y = 0;
                    ...
                    /*assemble_triangle([
                        Vertex {
                            ...
                            tex_coord: Vec2::new(0.0, 0.0) / 1.0,
                        },
                        Vertex {
                            position: Vec2::new(1.0, -1.0),
                            color: Vec4::new(1.0, 1.0, 1.0, 1.0) * 255.0,
                            tex_coord: Vec2::new(1.0, 0.0) / 1.0,
                        },
                        Vertex {
                            position: Vec2::new(1.0, 1.0),
                            color: Vec4::new(1.0, 1.0, 1.0, 1.0) * 255.0,
                            tex_coord: Vec2::new(1.0, 1.0) / 1.0,
                        },
                    ])?;
                    assemble_triangle([
                        Vertex {
                        ...
                        Vertex {
                            position: Vec2::new(-1.0, 1.0),
                            color: Vec4::new(1.0, 1.0, 1.0, 1.0) * 255.0,
                            tex_coord: Vec2::new(0.0, 1.0) / 1.0,
                        },
                        Vertex {
                            position: Vec2::new(-1.0, -1.0),
                            color: Vec4::new(1.0, 1.0, 1.0, 1.0) * 255.0,
