...
fn main() -> Result<()> {
    ...
    sim::generate(
        Crossbar::new("buster_1x2", 1, 2, 17, 1, 32, 2, &c).m,
    ...
    sim::generate(
        Crossbar::new("buster_2x1", 2, 1, 16, 0, 32, 2, &c).m,
        sim::GenerationOptions {
    ...
    sim::generate(
        Crossbar::new("buster_2x2", 2, 2, 17, 1, 128, 4, &c).m,
        sim::GenerationOptions {
    ...
    sim::generate(
        SkidBuffer::new("skid_buffer", 8, 8, &c).m,
        Default::default(),
        &mut file,
    )?;
