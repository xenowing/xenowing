...
mod tests {
    ...
    #[test]
    fn single_read_primary0() {
        let mut m = Buster::new();

        m.reset();

        m.primary0_bus_enable = true;
        m.primary0_bus_addr = 0xbabe;
        ...
        assert_eq!(m.replica_bus_addr, 0xbabe);
    ...
    fn single_read_primary1() {
        ...
        assert_eq!(m.replica_bus_enable, true);
        assert_eq!(m.replica_bus_addr, 0xbeef);
