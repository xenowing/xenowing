...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                               "$QSYS_SIMDIR/ddr3_controller/altera_avalon_sc_fifo.v"                                                   -work s0             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/altera_merlin_master_translator.sv"                                        -work s0             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/altera_merlin_slave_translator.sv"                                         -work s0             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_s0_mm_interconnect_0_rsp_demux.sv"                         -work s0             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/sequencer_m10.sv"                                                          -work s0             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/sequencer_pll_mgr.sv"                                                      -work s0             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                               "$QSYS_SIMDIR/ddr3_controller/rw_manager_m10_ac_ROM.v"                                                   -work s0             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                               "$QSYS_SIMDIR/ddr3_controller/rw_manager_m10_inst_ROM.v"                                                 -work s0             
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                               "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_p0_reset_m10.v"                                            -work p0             
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_p0_memphy_m10.sv"                                          -work p0             
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_p0_dqdqs_pads_m10.sv"                                      -work p0             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_p0_read_datapath_m10.sv"                                   -work p0             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                               "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_p0_write_datapath_m10.v"                                   -work p0             
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_p0_simple_ddio_out_m10.sv"                                 -work p0             
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/max10emif_dcfifo.sv"                                                       -work p0             
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                               "$QSYS_SIMDIR/ddr3_controller/ddr3_controller_p0_addr_cmd_pads_m10.v"                                    -work p0             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                           "$QSYS_SIMDIR/ddr3_controller/altera_gpio_lite.sv"                                                       -work p0             
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L a0 -L ng0 -L c0 -L s0 -L m0 -L p0 -L pll0 -L ddr3_controller -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L a0 -L ng0 -L c0 -L s0 -L m0 -L p0 -L pll0 -L ddr3_controller -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver $TOP_LEVEL_NAME
}
